...
func (x *VerifyBindCodeRequest) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
var file_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x0b, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0xab, 0x01, 0x0a, 0x15, 0x56, 0x65, 0x72,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x04, 0x52, 0x04, 0x63,
	0x6f, 0x64, 0x65, 0x12, 0x1e, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x04, 0x20, 0x01,
	...
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x2a, 0x2c, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	...
	0x4e, 0x44, 0x10, 0x02, 0x32, 0x8a, 0x07, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x5f, 0x0a,
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	2,  // 12: api.auth.v1.Auth.Login:output_type -> api.auth.v1.LoginReply
	4,  // 13: api.auth.v1.Auth.LoginForApp:output_type -> api.auth.v1.LoginForAppReply
	2,  // 14: api.auth.v1.Auth.LoginTest:output_type -> api.auth.v1.LoginReply
	9,  // 15: api.auth.v1.Auth.Decrypt:output_type -> api.auth.v1.DecryptReply
	2,  // 16: api.auth.v1.Auth.GetInfo:output_type -> api.auth.v1.LoginReply
	15, // 17: api.auth.v1.Auth.SendCode:output_type -> api.auth.v1.SendCodeReply
	2,  // 18: api.auth.v1.Auth.VerifyLoginCode:output_type -> api.auth.v1.LoginReply
	2,  // 19: api.auth.v1.Auth.VerifyBindCode:output_type -> api.auth.v1.LoginReply
