...
const (
	Sms_Send_FullMethodName      = "/api.sms.v1.Sms/Send"
	Sms_SendBatch_FullMethodName = "/api.sms.v1.Sms/SendBatch"
)
...
type SmsClient interface {
	...
	SendBatch(ctx context.Context, in *SendBatchRequest, opts ...grpc.CallOption) (*SendBatchReply, error)
}
...
func (c *smsClient) SendBatch(ctx context.Context, in *SendBatchRequest, opts ...grpc.CallOption) (*SendBatchReply, error) {
	out := new(SendBatchReply)
	err := c.cc.Invoke(ctx, Sms_SendBatch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SmsServer interface {
	...
	SendBatch(context.Context, *SendBatchRequest) (*SendBatchReply, error)
...
func (UnimplementedSmsServer) Send(context.Context, *SendRequest) (*SendReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Send not implemented")
}
func (UnimplementedSmsServer) SendBatch(context.Context, *SendBatchRequest) (*SendBatchReply, error) {
...
func _Sms_SendBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Sms_SendBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmsServer).SendBatch(ctx, req.(*SendBatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
