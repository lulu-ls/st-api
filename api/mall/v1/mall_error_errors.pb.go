...
func IsRechargeGeneralFailed(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_RECHARGE_GENERAL_FAILED.String() && e.Code == 430
}

func ErrorRechargeGeneralFailed(format string, args ...interface{}) *errors.Error {
	return errors.New(430, ErrorReason_RECHARGE_GENERAL_FAILED.String(), fmt.Sprintf(format, args...))
}
