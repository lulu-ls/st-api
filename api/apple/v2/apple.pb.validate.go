...
// Validate checks the field values on ApplePayRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *ApplePayRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ApplePayRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ApplePayRequestMultiError, or nil if none found.
func (m *ApplePayRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ApplePayRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ApplePayRequestMultiError(errors)
	}

	return nil
}

// ApplePayRequestMultiError is an error wrapping multiple validation errors
// returned by ApplePayRequest.ValidateAll() if the designated constraints
// aren't met.
type ApplePayRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ApplePayRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ApplePayRequestMultiError) AllErrors() []error { return m }

// ApplePayRequestValidationError is the validation error returned by
// ApplePayRequest.Validate if the designated constraints aren't met.
type ApplePayRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ApplePayRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ApplePayRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ApplePayRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ApplePayRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ApplePayRequestValidationError) ErrorName() string { return "ApplePayRequestValidationError" }

// Error satisfies the builtin error interface
func (e ApplePayRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sApplePayRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ApplePayRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ApplePayRequestValidationError{}

// Validate checks the field values on ApplePayReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ApplePayReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ApplePayReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ApplePayReplyMultiError, or
// nil if none found.
func (m *ApplePayReply) ValidateAll() error {
	return m.validate(true)
}

func (m *ApplePayReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ApplePayReplyMultiError(errors)
	}

	return nil
}

// ApplePayReplyMultiError is an error wrapping multiple validation errors
// returned by ApplePayReply.ValidateAll() if the designated constraints
// aren't met.
type ApplePayReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ApplePayReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ApplePayReplyMultiError) AllErrors() []error { return m }

// ApplePayReplyValidationError is the validation error returned by
// ApplePayReply.Validate if the designated constraints aren't met.
type ApplePayReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ApplePayReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ApplePayReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ApplePayReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ApplePayReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ApplePayReplyValidationError) ErrorName() string { return "ApplePayReplyValidationError" }

// Error satisfies the builtin error interface
func (e ApplePayReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ApplePayReplyValidationError{}
