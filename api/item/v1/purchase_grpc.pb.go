...
const (
	...
	Purchase_AppleBuy_FullMethodName          = "/api.item.v1.Purchase/AppleBuy"
...
type PurchaseClient interface {
	...
	AppleBuy(ctx context.Context, in *AppleBuyRequest, opts ...grpc.CallOption) (*AppleBuyReply, error)
...
func (c *purchaseClient) AppleBuy(ctx context.Context, in *AppleBuyRequest, opts ...grpc.CallOption) (*AppleBuyReply, error) {
	out := new(AppleBuyReply)
	err := c.cc.Invoke(ctx, Purchase_AppleBuy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPurchaseServer) AppleBuy(context.Context, *AppleBuyRequest) (*AppleBuyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AppleBuy not implemented")
}
...
func _Purchase_AppleBuy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppleBuyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PurchaseServer).AppleBuy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Purchase_AppleBuy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PurchaseServer).AppleBuy(ctx, req.(*AppleBuyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Purchase_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AppleBuy",
			Handler:    _Purchase_AppleBuy_Handler,
		},
		{
			MethodName: "AppBuy",
