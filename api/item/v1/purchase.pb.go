...
func (x *JSBuyReply) GetEnv() string {
	if x != nil {
		return x.Env
	}
	return ""
...
func (x *AppleBuyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppleBuyRequest) ProtoMessage() {}

func (x *AppleBuyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_purchase_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppleBuyRequest.ProtoReflect.Descriptor instead.
func (*AppleBuyRequest) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{7}
}

func (x *AppleBuyRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *AppleBuyRequest) GetChannelId() int32 {
	if x != nil {
		return x.ChannelId
	}
	return 0
...
func (x *AppleBuyRequest) GetPurchaseId() int32 {
	if x != nil {
		return x.PurchaseId
	}
	return 0
...
func (x *AppleBuyRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AppleBuyRequest) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *AppleBuyReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppleBuyReply) ProtoMessage() {}

func (x *AppleBuyReply) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_purchase_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppleBuyReply.ProtoReflect.Descriptor instead.
func (*AppleBuyReply) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{8}
}

func (x *AppleBuyReply) GetIsPayed() v1.VirtualPayStatus {
	if x != nil {
		return x.IsPayed
	}
	return v1.VirtualPayStatus(0)
...
func (x *AppleBuyReply) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *AppleBuyReply) GetOrderAmount() float64 {
	if x != nil {
		return x.OrderAmount
	}
	return 0
...
func (x *AppleBuyReply) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *AppleBuyReply) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *AppleBuyReply) GetEnv() string {
	if x != nil {
		return x.Env
	}
	return ""
...
func (x *GetPurchaseRecordRequest) Reset() {
	*x = GetPurchaseRecordRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_item_v1_purchase_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPurchaseRecordRequest) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{11}
}
...
func (x *GetPurchaseRecordReply) Reset() {
	*x = GetPurchaseRecordReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_item_v1_purchase_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPurchaseRecordReply) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{12}
}
...
func (x *AppBuyRequest) Reset() {
	*x = AppBuyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_item_v1_purchase_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AppBuyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppBuyRequest) ProtoMessage() {}

func (x *AppBuyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_purchase_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppBuyRequest.ProtoReflect.Descriptor instead.
func (*AppBuyRequest) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{13}
}

func (x *AppBuyRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *AppBuyRequest) GetChannelId() int32 {
	if x != nil {
		return x.ChannelId
	}
	return 0
...
func (x *AppBuyRequest) GetPurchaseId() int32 {
	if x != nil {
		return x.PurchaseId
	}
	return 0
...
func (x *AppBuyRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AppBuyRequest) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
type AppBuyReply struct {
	...
	IsPayed     v1.VirtualPayStatus `protobuf:"varint,9,opt,name=is_payed,json=isPayed,proto3,enum=api.wx.v1.VirtualPayStatus" json:"is_payed,omitempty"` // 是否支付成功, 0 否 1是
	OrderAmount float64             `protobuf:"fixed64,10,opt,name=order_amount,json=orderAmount,proto3" json:"order_amount,omitempty"`                   // 订单金额
	Quantity    int32               `protobuf:"varint,11,opt,name=quantity,proto3" json:"quantity,omitempty"`                                             // 购买数量
	Title       string              `protobuf:"bytes,12,opt,name=title,proto3" json:"title,omitempty"`                                                    // 标题
}

func (x *AppBuyReply) Reset() {
	*x = AppBuyReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_item_v1_purchase_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AppBuyReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppBuyReply) ProtoMessage() {}

func (x *AppBuyReply) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_purchase_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppBuyReply.ProtoReflect.Descriptor instead.
func (*AppBuyReply) Descriptor() ([]byte, []int) {
	return file_item_v1_purchase_proto_rawDescGZIP(), []int{14}
}

func (x *AppBuyReply) GetAppId() string {
	if x != nil {
		return x.AppId
	}
	return ""
...
func (x *AppBuyReply) GetPartnerId() string {
	if x != nil {
		return x.PartnerId
	}
	return ""
...
func (x *AppBuyReply) GetPrepayId() string {
	if x != nil {
		return x.PrepayId
	}
	return ""
...
func (x *AppBuyReply) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *AppBuyReply) GetNonceStr() string {
	if x != nil {
		return x.NonceStr
	}
	return ""
...
func (x *AppBuyReply) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
func (x *AppBuyReply) GetSign() string {
	if x != nil {
		return x.Sign
	}
	return ""
...
func (x *AppBuyReply) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *AppBuyReply) GetIsPayed() v1.VirtualPayStatus {
	if x != nil {
		return x.IsPayed
	}
	return v1.VirtualPayStatus(0)
...
func (x *AppBuyReply) GetOrderAmount() float64 {
	if x != nil {
		return x.OrderAmount
	}
	return 0
...
func (x *AppBuyReply) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *AppBuyReply) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
var file_item_v1_purchase_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xc6, 0x01, 0x0a, 0x0a,
	...
	0x03, 0x65, 0x6e, 0x76, 0x22, 0x9c, 0x01, 0x0a, 0x0f, 0x41, 0x70, 0x70, 0x6c, 0x65, 0x42, 0x75,
	...
	0x0a, 0x0b, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
	...
	0x72, 0x49, 0x64, 0x22, 0xc9, 0x01, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x6c, 0x65, 0x42, 0x75, 0x79,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x36, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x70, 0x61, 0x79, 0x65,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x77, 0x78,
	0x2e, 0x76, 0x31, 0x2e, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x50, 0x61, 0x79, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x07, 0x69, 0x73, 0x50, 0x61, 0x79, 0x65, 0x64, 0x12, 0x19, 0x0a,
	...
	0x72, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x71,
	0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x71,
	0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	...
	0x35, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x70, 0x75, 0x72, 0x63,
	0x68, 0x61, 0x73, 0x65, 0x49, 0x64, 0x22, 0x96, 0x03, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x50, 0x75,
	0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x70,
	0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0a, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08,
	...
	,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x10, 0x0a,
	0x03, 0x74, 0x61, 0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x22,
	0x35, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65,
	...
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xd9, 0x02, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x50, 0x75,
	0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x35, 0x0a, 0x17, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61,
	0x73, 0x65, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x14, 0x69, 0x74, 0x65, 0x6d, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65,
	0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65,
	...
	,
	...
	0x72, 0x61, 0x22, 0x9a, 0x01, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x42, 0x75, 0x79, 0x52, 0x65, 0x71,
	...
	0x09, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x75,
	0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0a, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x75,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x73, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x39,
	0x0a, 0x0b, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x74, 0x65, 0x6d, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a,
	0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x75, 0x6c, 0x75,
	0x2d, 0x6c, 0x73, 0x2f, 0x73, 0x74, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x69,
...
var file_item_v1_purchase_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_item_v1_purchase_proto_goTypes = []interface{}{
	...
	(*AppleBuyRequest)(nil),          // 7: api.item.v1.AppleBuyRequest
	(*AppleBuyReply)(nil),            // 8: api.item.v1.AppleBuyReply
	(*GetPurchaseRequest)(nil),       // 9: api.item.v1.GetPurchaseRequest
	(*GetPurchaseReply)(nil),         // 10: api.item.v1.GetPurchaseReply
	(*GetPurchaseRecordRequest)(nil), // 11: api.item.v1.GetPurchaseRecordRequest
	(*GetPurchaseRecordReply)(nil),   // 12: api.item.v1.GetPurchaseRecordReply
	(*AppBuyRequest)(nil),            // 13: api.item.v1.AppBuyRequest
	(*AppBuyReply)(nil),              // 14: api.item.v1.AppBuyReply
	(v1.VirtualPayStatus)(0),         // 15: api.wx.v1.VirtualPayStatus
}
var file_item_v1_purchase_proto_depIdxs = []int32{
	...
	15, // 1: api.item.v1.VirtualBuyReply.is_payed:type_name -> api.wx.v1.VirtualPayStatus
	15, // 2: api.item.v1.JSBuyReply.is_payed:type_name -> api.wx.v1.VirtualPayStatus
	15, // 3: api.item.v1.AppleBuyReply.is_payed:type_name -> api.wx.v1.VirtualPayStatus
	15, // 4: api.item.v1.AppBuyReply.is_payed:type_name -> api.wx.v1.VirtualPayStatus
	3,  // 5: api.item.v1.Purchase.VirtualBuy:input_type -> api.item.v1.VirtualBuyRequest
	5,  // 6: api.item.v1.Purchase.JSBuy:input_type -> api.item.v1.JSBuyRequest
	7,  // 7: api.item.v1.Purchase.AppleBuy:input_type -> api.item.v1.AppleBuyRequest
	13, // 8: api.item.v1.Purchase.AppBuy:input_type -> api.item.v1.AppBuyRequest
	0,  // 9: api.item.v1.Purchase.PurchaseList:input_type -> api.item.v1.PurchaseListRequest
	9,  // 10: api.item.v1.Purchase.GetPurchase:input_type -> api.item.v1.GetPurchaseRequest
	11, // 11: api.item.v1.Purchase.GetPurchaseRecord:input_type -> api.item.v1.GetPurchaseRecordRequest
	4,  // 12: api.item.v1.Purchase.VirtualBuy:output_type -> api.item.v1.VirtualBuyReply
	6,  // 13: api.item.v1.Purchase.JSBuy:output_type -> api.item.v1.JSBuyReply
	8,  // 14: api.item.v1.Purchase.AppleBuy:output_type -> api.item.v1.AppleBuyReply
	14, // 15: api.item.v1.Purchase.AppBuy:output_type -> api.item.v1.AppBuyReply
	1,  // 16: api.item.v1.Purchase.PurchaseList:output_type -> api.item.v1.PurchaseListReply
	10, // 17: api.item.v1.Purchase.GetPurchase:output_type -> api.item.v1.GetPurchaseReply
	12, // 18: api.item.v1.Purchase.GetPurchaseRecord:output_type -> api.item.v1.GetPurchaseRecordReply
...
func file_item_v1_purchase_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_item_v1_purchase_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_item_v1_purchase_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_item_v1_purchase_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppBuyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_item_v1_purchase_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppBuyReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
