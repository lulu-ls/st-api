...
const (
	...
	Game_DailyTask_FullMethodName        = "/api.game.v1.Game/DailyTask"
)
...
type GameClient interface {
	...
	// 每日任务
	DailyTask(ctx context.Context, in *DailyTaskRequest, opts ...grpc.CallOption) (*DailyTaskReply, error)
}
...
func (c *gameClient) DailyTask(ctx context.Context, in *DailyTaskRequest, opts ...grpc.CallOption) (*DailyTaskReply, error) {
	out := new(DailyTaskReply)
	err := c.cc.Invoke(ctx, Game_DailyTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGameServer) DailyTask(context.Context, *DailyTaskRequest) (*DailyTaskReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DailyTask not implemented")
}
...
func _Game_DailyTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DailyTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameServer).DailyTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Game_DailyTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServer).DailyTask(ctx, req.(*DailyTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Game_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Game_DailyTask_Handler,
		},
	},
