...
const (
	Template_Send_FullMethodName = "/api.wx.v1.Template/Send"
)
...
func (c *templateClient) Send(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*SendMsgReply, error) {
	out := new(SendMsgReply)
	err := c.cc.Invoke(ctx, Template_Send_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTemplateServer) Send(context.Context, *SendMsgRequest) (*SendMsgReply, error) {
...
func _Template_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Template_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServer).Send(ctx, req.(*SendMsgRequest))
	}
...
var Template_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.wx.v1.Template",
