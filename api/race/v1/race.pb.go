...
const (
	OptionType__   OptionType = 0
	OptionType_AND OptionType = 1
	OptionType_OR  OptionType = 2
)
...
func (OptionType) Descriptor() protoreflect.EnumDescriptor {
	return file_race_v1_race_proto_enumTypes[1].Descriptor()
}

func (OptionType) Type() protoreflect.EnumType {
	return &file_race_v1_race_proto_enumTypes[1]
}
...
type RaceTypeRequest struct {
	...
	HomeShow   int32 `protobuf:"varint,2,opt,name=home_show,json=homeShow,proto3" json:"home_show,omitempty"`
	GameTypeId int32 `protobuf:"varint,3,opt,name=game_type_id,json=gameTypeId,proto3" json:"game_type_id,omitempty"` // 游戏类型 1: 挖坑 2: 斗地主
}
...
func (x *RaceTypeRequest) GetGameTypeId() int32 {
	if x != nil {
		return x.GameTypeId
	}
	return 0
...
type RaceTypeItem struct {
	...
	GameTypeId   int32  `protobuf:"varint,5,opt,name=game_type_id,json=gameTypeId,proto3" json:"game_type_id,omitempty"` // 游戏类型 1: 挖坑 2: 斗地主
}
...
func (x *RaceTypeItem) GetGameTypeId() int32 {
	if x != nil {
		return x.GameTypeId
	}
	return 0
...
type ListRaceItem struct {
	...
	OptionType         OptionType    `protobuf:"varint,19,opt,name=option_type,json=optionType,proto3,enum=api.race.v1.OptionType" json:"option_type,omitempty"`   // 报名费类型 1且 2或
}
...
func (x *ListRaceItem) GetOptionType() OptionType {
	if x != nil {
		return x.OptionType
	}
	return OptionType__
...
type SignupItem struct {
	...
	UserTotal int32  `protobuf:"varint,4,opt,name=user_total,json=userTotal,proto3" json:"user_total,omitempty"` // 用户账户道具剩余数量
}
...
func (x *SignupItem) GetUserTotal() int32 {
	if x != nil {
		return x.UserTotal
	}
	return 0
...
type RaceSignupCancelReply struct {
	...
	GameConfigId int32  `protobuf:"varint,1,opt,name=game_config_id,json=gameConfigId,proto3" json:"game_config_id,omitempty"` // 赛事配置 id
	Msg          string `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`                                          // 提示
}
...
func (x *RaceSignupCancelReply) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
type RaceBatchSignupCancelRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserIds      []int64 `protobuf:"varint,1,rep,packed,name=user_ids,json=userIds,proto3" json:"user_ids,omitempty"`           // 用户 id
	GameConfigId int32   `protobuf:"varint,2,opt,name=game_config_id,json=gameConfigId,proto3" json:"game_config_id,omitempty"` // 赛事配置 id
}

func (x *RaceBatchSignupCancelRequest) Reset() {
	*x = RaceBatchSignupCancelRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RaceBatchSignupCancelRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceBatchSignupCancelRequest) ProtoMessage() {}

func (x *RaceBatchSignupCancelRequest) ProtoReflect() protoreflect.Message {
	mi := &file_race_v1_race_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RaceBatchSignupCancelRequest.ProtoReflect.Descriptor instead.
func (*RaceBatchSignupCancelRequest) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{22}
}

func (x *RaceBatchSignupCancelRequest) GetUserIds() []int64 {
	if x != nil {
		return x.UserIds
	}
	return nil
...
func (x *RaceBatchSignupCancelRequest) GetGameConfigId() int32 {
	if x != nil {
		return x.GameConfigId
	}
	return 0
...
type RaceBatchSignupCancelReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// int32 game_config_id = 1; // 赛事配置 id
	ErrList []*RaceBatchSignupCancelItem `protobuf:"bytes,1,rep,name=err_list,json=errList,proto3" json:"err_list,omitempty"`
}

func (x *RaceBatchSignupCancelReply) Reset() {
	*x = RaceBatchSignupCancelReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *RaceBatchSignupCancelReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceBatchSignupCancelReply) ProtoMessage() {}

func (x *RaceBatchSignupCancelReply) ProtoReflect() protoreflect.Message {
	mi := &file_race_v1_race_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RaceBatchSignupCancelReply.ProtoReflect.Descriptor instead.
func (*RaceBatchSignupCancelReply) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{23}
}

func (x *RaceBatchSignupCancelReply) GetErrList() []*RaceBatchSignupCancelItem {
	if x != nil {
		return x.ErrList
	}
	return nil
...
type RaceBatchSignupCancelItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId int64  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 用户 id
	Err    string `protobuf:"bytes,2,opt,name=err,proto3" json:"err,omitempty"`                      // 错误原因
}

func (x *RaceBatchSignupCancelItem) Reset() {
	*x = RaceBatchSignupCancelItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_race_v1_race_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RaceBatchSignupCancelItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceBatchSignupCancelItem) ProtoMessage() {}

func (x *RaceBatchSignupCancelItem) ProtoReflect() protoreflect.Message {
	mi := &file_race_v1_race_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RaceBatchSignupCancelItem.ProtoReflect.Descriptor instead.
func (*RaceBatchSignupCancelItem) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{24}
}

func (x *RaceBatchSignupCancelItem) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *RaceBatchSignupCancelItem) GetErr() string {
	if x != nil {
		return x.Err
	}
	return ""
...
func (x *PodiumRequest) Reset() {
	*x = PodiumRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_race_v1_race_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PodiumRequest) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{25}
}
...
func (x *PodiumReply) Reset() {
	*x = PodiumReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_race_v1_race_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PodiumReply) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{26}
}
...
type GameRaceCheckRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GameRaceCheckRequest) Reset() {
	*x = GameRaceCheckRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_race_v1_race_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GameRaceCheckRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameRaceCheckRequest) ProtoMessage() {}

func (x *GameRaceCheckRequest) ProtoReflect() protoreflect.Message {
	mi := &file_race_v1_race_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameRaceCheckRequest.ProtoReflect.Descriptor instead.
func (*GameRaceCheckRequest) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{27}
}

func (x *GameRaceCheckRequest) GetGameConfigId() int32 {
	if x != nil {
		return x.GameConfigId
	}
	return 0
...
type GameRaceCheckReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GameRaceCheckReply) Reset() {
	*x = GameRaceCheckReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_race_v1_race_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GameRaceCheckReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameRaceCheckReply) ProtoMessage() {}

func (x *GameRaceCheckReply) ProtoReflect() protoreflect.Message {
	mi := &file_race_v1_race_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameRaceCheckReply.ProtoReflect.Descriptor instead.
func (*GameRaceCheckReply) Descriptor() ([]byte, []int) {
	return file_race_v1_race_proto_rawDescGZIP(), []int{28}
}
...
var file_race_v1_race_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x67, 0x0a, 0x0f, 0x52, 0x61, 0x63, 0x65,
	...
	,
	...
	,
	...
	0xfa, 0x04, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x49, 0x74, 0x65, 0x6d,
	...
	0x65, 0x12, 0x20, 0x0a, 0x0c, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x67, 0x61, 0x6d, 0x65, 0x54, 0x79, 0x70,
	0x65, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x67, 0x61, 0x6d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_race_v1_race_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_race_v1_race_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_race_v1_race_proto_goTypes = []interface{}{
	(SignupStatus)(0),                    // 0: api.race.v1.SignupStatus
	(OptionType)(0),                      // 1: api.race.v1.OptionType
	(*GameSeriesBindUserRequest)(nil),    // 2: api.race.v1.GameSeriesBindUserRequest
	(*GameSeriesBindUserReply)(nil),      // 3: api.race.v1.GameSeriesBindUserReply
	(*RaceTypeRequest)(nil),              // 4: api.race.v1.RaceTypeRequest
	(*RaceTypeReply)(nil),                // 5: api.race.v1.RaceTypeReply
	(*RaceTypeItem)(nil),                 // 6: api.race.v1.RaceTypeItem
	(*RaceListRequest)(nil),              // 7: api.race.v1.RaceListRequest
	(*RaceListReply)(nil),                // 8: api.race.v1.RaceListReply
	(*ListRaceItem)(nil),                 // 9: api.race.v1.ListRaceItem
	(*SignupItem)(nil),                   // 10: api.race.v1.SignupItem
	(*RaceDetailRequest)(nil),            // 11: api.race.v1.RaceDetailRequest
	(*RaceRewardRequest)(nil),            // 12: api.race.v1.RaceRewardRequest
	(*RaceRewardReply)(nil),              // 13: api.race.v1.RaceRewardReply
	(*RaceRewardRuleItem)(nil),           // 14: api.race.v1.RaceRewardRuleItem
	(*RaceRewardItem)(nil),               // 15: api.race.v1.RaceRewardItem
	(*RaceRewardRuleDetail)(nil),         // 16: api.race.v1.RaceRewardRuleDetail
	(*RaceRostrumItem)(nil),              // 17: api.race.v1.RaceRostrumItem
	(*RaceRuleRequest)(nil),              // 18: api.race.v1.RaceRuleRequest
	(*RaceRuleReply)(nil),                // 19: api.race.v1.RaceRuleReply
	(*RaceSignupRequest)(nil),            // 20: api.race.v1.RaceSignupRequest
	(*RaceSignupReply)(nil),              // 21: api.race.v1.RaceSignupReply
	(*RaceSignupCancelRequest)(nil),      // 22: api.race.v1.RaceSignupCancelRequest
	(*RaceSignupCancelReply)(nil),        // 23: api.race.v1.RaceSignupCancelReply
	(*RaceBatchSignupCancelRequest)(nil), // 24: api.race.v1.RaceBatchSignupCancelRequest
	(*RaceBatchSignupCancelReply)(nil),   // 25: api.race.v1.RaceBatchSignupCancelReply
	(*RaceBatchSignupCancelItem)(nil),    // 26: api.race.v1.RaceBatchSignupCancelItem
	(*PodiumRequest)(nil),                // 27: api.race.v1.PodiumRequest
	(*PodiumReply)(nil),                  // 28: api.race.v1.PodiumReply
	(*GameRaceCheckRequest)(nil),         // 29: api.race.v1.GameRaceCheckRequest
	(*GameRaceCheckReply)(nil),           // 30: api.race.v1.GameRaceCheckReply
}
var file_race_v1_race_proto_depIdxs = []int32{
	6,  // 0: api.race.v1.RaceTypeReply.list:type_name -> api.race.v1.RaceTypeItem
	9,  // 1: api.race.v1.RaceListReply.list:type_name -> api.race.v1.ListRaceItem
	10, // 2: api.race.v1.ListRaceItem.signup_item:type_name -> api.race.v1.SignupItem
	1,  // 3: api.race.v1.ListRaceItem.option_type:type_name -> api.race.v1.OptionType
	14, // 4: api.race.v1.RaceRewardReply.list:type_name -> api.race.v1.RaceRewardRuleItem
	17, // 5: api.race.v1.RaceRewardReply.rostrum_item:type_name -> api.race.v1.RaceRostrumItem
	15, // 6: api.race.v1.RaceRewardRuleItem.item:type_name -> api.race.v1.RaceRewardItem
	16, // 7: api.race.v1.RaceRewardItem.detail:type_name -> api.race.v1.RaceRewardRuleDetail
	26, // 8: api.race.v1.RaceBatchSignupCancelReply.err_list:type_name -> api.race.v1.RaceBatchSignupCancelItem
	4,  // 9: api.race.v1.Race.RaceType:input_type -> api.race.v1.RaceTypeRequest
	7,  // 10: api.race.v1.Race.RaceList:input_type -> api.race.v1.RaceListRequest
	11, // 11: api.race.v1.Race.RaceDetail:input_type -> api.race.v1.RaceDetailRequest
	12, // 12: api.race.v1.Race.RaceReward:input_type -> api.race.v1.RaceRewardRequest
	18, // 13: api.race.v1.Race.RaceRule:input_type -> api.race.v1.RaceRuleRequest
	20, // 14: api.race.v1.Race.RaceSignup:input_type -> api.race.v1.RaceSignupRequest
	22, // 15: api.race.v1.Race.RaceSignupCancel:input_type -> api.race.v1.RaceSignupCancelRequest
	24, // 16: api.race.v1.Race.RaceBatchSignupCancel:input_type -> api.race.v1.RaceBatchSignupCancelRequest
	27, // 17: api.race.v1.Race.Podium:input_type -> api.race.v1.PodiumRequest
	2,  // 18: api.race.v1.Race.GameSeriesBindUser:input_type -> api.race.v1.GameSeriesBindUserRequest
	29, // 19: api.race.v1.Race.GameRaceCheck:input_type -> api.race.v1.GameRaceCheckRequest
	5,  // 20: api.race.v1.Race.RaceType:output_type -> api.race.v1.RaceTypeReply
	8,  // 21: api.race.v1.Race.RaceList:output_type -> api.race.v1.RaceListReply
	9,  // 22: api.race.v1.Race.RaceDetail:output_type -> api.race.v1.ListRaceItem
	13, // 23: api.race.v1.Race.RaceReward:output_type -> api.race.v1.RaceRewardReply
	19, // 24: api.race.v1.Race.RaceRule:output_type -> api.race.v1.RaceRuleReply
	21, // 25: api.race.v1.Race.RaceSignup:output_type -> api.race.v1.RaceSignupReply
	23, // 26: api.race.v1.Race.RaceSignupCancel:output_type -> api.race.v1.RaceSignupCancelReply
	25, // 27: api.race.v1.Race.RaceBatchSignupCancel:output_type -> api.race.v1.RaceBatchSignupCancelReply
	28, // 28: api.race.v1.Race.Podium:output_type -> api.race.v1.PodiumReply
	3,  // 29: api.race.v1.Race.GameSeriesBindUser:output_type -> api.race.v1.GameSeriesBindUserReply
	30, // 30: api.race.v1.Race.GameRaceCheck:output_type -> api.race.v1.GameRaceCheckReply
...
func file_race_v1_race_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_race_v1_race_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RaceBatchSignupCancelRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_race_v1_race_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RaceBatchSignupCancelReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_race_v1_race_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RaceBatchSignupCancelItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_race_v1_race_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_race_v1_race_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
		...
		file_race_v1_race_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GameRaceCheckRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_race_v1_race_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GameRaceCheckReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
