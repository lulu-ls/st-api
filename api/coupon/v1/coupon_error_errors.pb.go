...
func IsVerificationErr(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_VERIFICATION_ERR.String() && e.Code == 410
}

// 核销失败
func ErrorVerificationErr(format string, args ...interface{}) *errors.Error {
	return errors.New(410, ErrorReason_VERIFICATION_ERR.String(), fmt.Sprintf(format, args...))
}
