...
const (
	...
	Order_RetryPay_FullMethodName    = "/api.order.v1.Order/RetryPay"
...
type OrderClient interface {
	...
	RetryPay(ctx context.Context, in *RetryPayRequest, opts ...grpc.CallOption) (*CreateOrderReply, error)
...
func (c *orderClient) RetryPay(ctx context.Context, in *RetryPayRequest, opts ...grpc.CallOption) (*CreateOrderReply, error) {
	out := new(CreateOrderReply)
	err := c.cc.Invoke(ctx, Order_RetryPay_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	RetryPay(context.Context, *RetryPayRequest) (*CreateOrderReply, error)
...
func (UnimplementedOrderServer) RetryPay(context.Context, *RetryPayRequest) (*CreateOrderReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RetryPay not implemented")
}
...
func _Order_RetryPay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetryPayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).RetryPay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_RetryPay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).RetryPay(ctx, req.(*RetryPayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RetryPay",
			Handler:    _Order_RetryPay_Handler,
		},
		{
